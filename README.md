...
<p align="center">
  <img src=".github/assets/screenshots/worker-profiles.svg" width="900" alt="Machinist worker page showing the connected Mac mini, repositories, environment, and available Codex, Claude, and DGX profiles">
</p>

<p align="center"><sub>Scalable interface capture of a connected macOS worker advertising only its approved repositories and available profiles.</sub></p>
